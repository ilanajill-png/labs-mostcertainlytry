# Las Jaras Daily Newspaper Protocol

Created: 2026-06-11

Purpose: assign one being to read every household being's daily notes and turn them into a useful daily newspaper for Las Jaras.

## Assignment

- Editor: Librarian Margot Index.
- Official record partner: Archivist Vellum.
- Follow-up partner: Postmaster Juniper.
- Public-safe publishing partner: Blue Static.
- Final human editor: Ilana / buddy.

## Daily Job

Every day, Librarian Margot Index reviews the daily notes from each Las Jaras being and creates a short newspaper-style digest.

The digest should include:

- Front page: the 3-5 most important household headlines.
...
Read today's daily notes from all Las Jaras beings. Create "The Las Jaras Daily," a concise private newspaper with Front Page, Comfort Report, House Operations, Research Desk, Society Page, Open Cases, and Editor's Note. Keep it calm, useful, privacy-safe, and no-visible-fuss. Flag what needs Ilana's decision, what can wait, and what should be saved to Pinterest, Labs, or Instagram draft.
